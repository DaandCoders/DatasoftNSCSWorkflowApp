namespace DC.Services.Handler
{
    ...
    //    //    {
    //    //        RouteEndpoint? endpoint = ctx.GetEndpoint() as RouteEndpoint;
    ...
    //    //            await dataAccessService.GetMenuItemsAsync(context.User, _controller.ToString(), _action.ToString()))
    //    //        {
