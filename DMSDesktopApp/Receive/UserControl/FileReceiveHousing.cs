...
{
    public partial class FileReceiveHousing : UserControl
    {
        ...
        public FileReceiveHousing(IDbContextFactory<ApplicationDbContext> dbContext, IMemoryCache cache, ITranslationService translationService, int loggedInUserId, string selectedDepartment)
        {
            InitializeComponent();
        ...
        private async void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string allotteeName = txtAllotteeName.Text.Trim();
            ...
            if (string.IsNullOrWhiteSpace(fileNumber) || year == 0 || string.IsNullOrWhiteSpace(allotteeName))
            {
        ...
        private void ClearFields()
        {
            txtFileNumber.Clear();
            mtbYear.Clear();
            txtAllotteeName.Clear();
            txtBarcode.Clear();

        }

        private void FileReceiveHousing_Load(object sender, EventArgs e)
        {
