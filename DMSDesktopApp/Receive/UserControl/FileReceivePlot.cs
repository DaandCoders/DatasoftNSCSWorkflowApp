...
{
    public partial class FileReceivePlot : UserControl
    {
        ...
        public FileReceivePlot(IDbContextFactory<ApplicationDbContext> dbContext, IMemoryCache cache, ITranslationService translationService, int loggedInUserId, string selectedDepartment)
        {
            InitializeComponent();
        ...
        private async void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(fileNumber) || string.IsNullOrWhiteSpace(schemeName) || string.IsNullOrWhiteSpace(plotNumber))
            {
        ...
        private void FileReceivePlot_Load(object sender, EventArgs e)
        {
